...
class guideTable: UIViewController {
    ...
    var guides = [["_id":["$oid":"5f8c6e6fc7a33e9aa8d50feb"],"references":"","text":"I am monke.","title":"monke"]]
...
//        getGuides()
//        DispatchQueue.main.async { self.guideView.reloadData() }
//        print("what the")
        refreshControl.addTarget(self, action: #selector(guideTable.handleRefresh(_:)), for: UIControl.Event.valueChanged)
    }
...
//            let guidePage = viewController as? guidePage
//            guidePage?.title = "meme2"
//        }
//    }
